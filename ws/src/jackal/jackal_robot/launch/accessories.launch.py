...
def generate_launch_description():
    ...
    primary_lidar_enable = EnvironmentVariable('JACKAL_LASER', default_value='false')
    primary_lidar_model = EnvironmentVariable('JACKAL_LASER_MODEL', default_value='ust10')
    primary_lidar_ip = EnvironmentVariable('JACKAL_LASER_HOST', default_value='192.168.131.20')
    primary_lidar_topic = EnvironmentVariable('JACKAL_LASER_TOPIC', default_value='front/scan')
    primary_lidar_mount = EnvironmentVariable('JACKAL_LASER_MOUNT', default_value='front_laser')
    ...
    secondary_lidar_enable = EnvironmentVariable('JACKAL_LASER_SECONDARY', default_value='false')
    secondary_lidar_model = EnvironmentVariable('JACKAL_LASER_SECONDARY_MODEL', default_value='ust10')
    secondary_lidar_ip = EnvironmentVariable('JACKAL_LASER_SECONDARY_HOST', default_value='192.168.131.21')
    secondary_lidar_topic = EnvironmentVariable('JACKAL_LASER_SECONDARY_TOPIC', default_value='rear/scan')
    secondary_lidar_mount = EnvironmentVariable('JACKAL_LASER_SECONDARY_MOUNT', default_value='rear_laser')
    ...
    primary_lidar_3d_enable = EnvironmentVariable('JACKAL_3D_LASER', default_value='false')
    primary_lidar_3d_model = EnvironmentVariable('JACKAL_3D_LASER_MODEL', default_value='vlp16')
    primary_lidar_3d_ip = EnvironmentVariable('JACKAL_3D_LASER_HOST', default_value='192.168.131.20')
    primary_lidar_3d_topic = EnvironmentVariable('JACKAL_3D_LASER_TOPIC', default_value='mid/points')
    primary_lidar_3d_mount = EnvironmentVariable('JACKAL_3D_LASER_MOUNT', default_value='mid_velodyne')
    ...
    # primary_gps_enable = EnvironmentVariable('JACKAL_GPS', default_value='false')
    # primary_gps_port = EnvironmentVariable('JACKAL_GPS_PORT', default_value='/dev/clearpath/gps')
    # primary_gps_baud = EnvironmentVariable('JACKAL_GPS_BAUD', default_value='57600')
    # primary_gps_mount = EnvironmentVariable('JACKAL_GPS_MOUNT', default_value='gps_link')
    ...
    primary_imu_enable = EnvironmentVariable('JACKAL_IMU', default_value='false')
    primary_imu_model = EnvironmentVariable('JACKAL_IMU_MODEL', default_value='microstrain')
    primary_imu_port = EnvironmentVariable('JACKAL_IMU_PORT', default_value='/dev/microstrain')
    primary_imu_baud = EnvironmentVariable('JACKAL_IMU_BAUD', default_value='115200')
    primary_imu_mount = EnvironmentVariable('JACKAL_IMU_MOUNT', default_value='imu_link')
